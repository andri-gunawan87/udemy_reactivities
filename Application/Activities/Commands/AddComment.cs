...
public class AddComment
{
        ...
        : IRequestHandler<Command, Result<CommentDto>>
    {
        public async Task<Result<CommentDto>> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            if (activity == null) return Result<CommentDto>.Failure("Cannot find the activity", (int)HttpStatusCode.BadRequest);
            ...
            return result
                ...
                : Result<CommentDto>.Failure("Failed to add comment!", (int)HttpStatusCode.BadRequest);
        }
    }
}
